...
$projectProperties = "#Generated by Javscode v0.1-beta
excludes=
...
dist.jlink.output=`${dist.jlink.dir}/vscode
...
function export() {
    ...
    #dist.jlink.output=`${dist.jlink.dir}/vscode
    Set-Content -Path "$nbproject/project.properties" -Value ($projectProperties + "`nmain.class=$mainClassWithoutExtension")
